  ...
  return (
    <section id="about" className="flex items-center justify-center" style={sectionStyle}>
      <div className="container mx-auto flex px-5 py-20 flex-col items-center justify-center mb-10">
        <div className="lg:pl-24 md:pl-16 flex flex-col sm:items-start sm:text-left mb-16 md:mb-0 text-center">
          <p className="no-wrap text-md sm:text-sm md:text-md lg:text-xl mx-5 md:mx-8 mb-2 leading-relaxed text-[#D2931B]" style={{ fontFamily: 'Inconsolata' }}>
            Hi, my name is
          </p>
          ...
          <p className="md:text-md lg:text-xl md:mx-8 mb-8 paragraph max-w-xl" style={{ fontFamily: 'Inconsolata' }}>
