...
export default function MainApp() {
  ...
  return (
    <section section id="bio" className="flex items-center justify-center mb-20">
        <div className="snap-y snap-mandatory overflow-auto">
            <div className="flex snap-start" style={{ fontFamily: 'Inconsolata' }}>
                <div className="w-1/2">
                </div>
                <div className="sm:w-full md:w-1/2 px-10 pb-10" >
                    <h1 className="md:text-3xl lg:text-4xl font-bold mb-10 text-[#D2931B]">
                        Some more about me.
                    </h1>
                    <p class="sm:text-xl lg:text-xl sm:w-full md:w-full lg:w-10/12">
